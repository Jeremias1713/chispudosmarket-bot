...
function buildSystemPrompt(knownCity, knownProduct, orderClosed, dataAlreadyRequested, shippingStage) {
...
async function getAssistantReply(history, userText, knownCity, knownProduct, orderClosed, dataAlreadyRequested, shippingStage) {
  const settings = getSettings();
  ...
  const messages = [
    { role: 'system', content: buildSystemPrompt(knownCity, knownProduct, orderClosed, dataAlreadyRequested, shippingStage) },
    ...sanitizedHistory,
